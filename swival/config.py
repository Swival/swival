...
def generate_config(
    ...
    *existing_raw* and appended after all scalar keys.
    ...
    template_lines = [
        ...
        "",
        "# --- Provider / model ---",
        '# provider = "lmstudio"          # "lmstudio" | "llamacpp" | "huggingface" | "openrouter" | "generic" | "applefm" | "google" | "geap" | "chatgpt" | "github_copilot" | "bedrock" | "command"',
        ...
        "#",
        "# [profiles.copilot]",
        '# provider = "github_copilot"   # GitHub Copilot subscription; one-time device login on first run',
        '# model = "gpt-5.1"',
        "",
        "# --- MCP server examples ---",
